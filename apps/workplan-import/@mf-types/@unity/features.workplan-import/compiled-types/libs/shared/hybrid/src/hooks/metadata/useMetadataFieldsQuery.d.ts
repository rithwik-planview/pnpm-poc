...
export declare function fileteredMetadataFieldsQueryOptions(options: Options<MetadataGetAvailableFieldsData>): import("@tanstack/react-query").OmitKeyof<import("@tanstack/react-query").UseQueryOptions<FieldsResponseAugumented[], Error, FieldsResponseAugumented[], [Pick<import("../../client/sdk.gen").Options<MetadataGetAvailableFieldsData>, "path" | "headers" | "body" | "query" | "baseURL"> & {
    _id: string;
    _infinite?: boolean;
}]>, "queryFn"> & {
    queryFn?: import("@tanstack/react-query").QueryFunction<FieldsResponseAugumented[], [Pick<import("../../client/sdk.gen").Options<MetadataGetAvailableFieldsData>, "path" | "headers" | "body" | "query" | "baseURL"> & {
        _id: string;
        _infinite?: boolean;
    }], never> | undefined;
} & {
    queryKey: [Pick<import("../../client/sdk.gen").Options<MetadataGetAvailableFieldsData>, "path" | "headers" | "body" | "query" | "baseURL"> & {
        _id: string;
        _infinite?: boolean;
    }] & {
